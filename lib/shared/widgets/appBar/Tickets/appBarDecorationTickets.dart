...
class MyAppBarDesktopTickets extends StatelessWidget implements PreferredSizeWidget {
  final String title;
...
class MyAppBarMobileTickets extends StatelessWidget implements PreferredSizeWidget {
  final String title;
  final Widget? suffixWidget;
  final BuildContext context;
  final bool backButton;

  MyAppBarMobileTickets({
    required this.title,
    this.suffixWidget,
    required this.context,
    required this.backButton,
    ...
    return AppBar(
      ...
      leading: backButton ? IconButton(
        ...
        builder: (context) => IconButton(
          icon: const Icon(IconLibrary.iconMenu, color: Colors.white,),
