...
class DocumentUploadModalFisica extends StatefulWidget {
  final Function(List<String>) onSave;

  DocumentUploadModalFisica({required this.onSave});

  @override
  _DocumentUploadModalFisicaState createState() => _DocumentUploadModalFisicaState();
}

class _DocumentUploadModalFisicaState extends State<DocumentUploadModalFisica> {
  late Size size;
            ...
            Expanded(
              child: SingleChildScrollView(
                child: GridView.builder(
                  shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), itemCount: _labels.length,
                        ...
                        Center(child: Column(
                          ...
                          children: [Text(_labels[index],
                            ...
                            MouseRegion(
                              ...
                              onDoubleTap: () {
                                if (_filePaths[index] != null) {_showFilePreviewDialog(_filePaths[index]!);
                                }},
              ...
              child: Row(
                ...
                children: [
                  ElevatedButton(
                    ...
                    child: Text("Cancelar"),
                    style: TextButton.styleFrom(minimumSize: Size(250, 40), primary: theme.colorScheme.onPrimary, backgroundColor: theme.colorScheme.inversePrimary,
                    ),
                  ),
                  SizedBox(width: 8.0),
                  ElevatedButton(
                    ...
                    child: Text("Guardar"),
                    style: TextButton.styleFrom(minimumSize: Size(250, 40), primary: theme.colorScheme.onPrimary, backgroundColor: theme.colorScheme.secondary,
                    ),
                  ),
                ],
              ),
    ...
    showMenu(
      ...
      items: [
        PopupMenuItem<String>(
          value: 'Eliminar',
          height: 25,
          child: Text("Eliminar", style: DefaultTextStyle.of(context).style.copyWith(fontSize: 13.2, fontWeight: FontWeight.normal, color: theme.colorScheme.onPrimary,)),
        ),
      ],
    ).then((value) {
      if (value == 'Eliminar') {
