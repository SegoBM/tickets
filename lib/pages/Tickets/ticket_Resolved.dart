...
class ticket_Resolved extends StatefulWidget {
  String id;
  ticket_Resolved({Key? key, required String this.id}) : super(key: key);

  @override
  _ticketResolvedState createState() => _ticketResolvedState();
}

class _ticketResolvedState extends State<ticket_Resolved> {
