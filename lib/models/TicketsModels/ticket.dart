...
List <TicketsModels> ticketsModelsFromJson(String str) =>
    List <TicketsModels>.from(json.decode(str).map((x) => TicketsModels.fromJson(x)));
TicketsModels ticketsModelsSingleFromJson(String str) => TicketsModels.fromJson5(json.decode(str));
