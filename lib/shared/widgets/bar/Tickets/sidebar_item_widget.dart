...
class SidebarItemWidgetTickets extends StatefulWidget {
  const SidebarItemWidgetTickets({
...
class _CollapsibleItemWidgetState extends State<SidebarItemWidgetTickets> {
  ...
  Widget _body(){
    return LayoutBuilder(builder: (context, boxConstraints) {
      ...
      (widget.isCollapsed!? Tooltip(waitDuration: const Duration(milliseconds: 600),
        message: widget.title,child: GestureDetector(
          onTap: widget.onTap,
          onLongPress: widget.onLongPress,
          child: Container(
            decoration: BoxDecoration(color: widget.isSelected! ? ColorPalette.ticketsSelectedColor : _underline ?
            ColorPalette.ticketsFocusColor : Colors.transparent,
